                      ...
                      <View style={styles.responseHeader}>
                        ...
                        <TouchableOpacity
                          onPress={() =>
                            copyToClipboard(
                              JSON.stringify(
                                endpointStatus[endpoint.path]?.data,
                                null,
                                2,
                              ),
                            )
                  ...
                  {endpointStatus[endpoint.path]?.status === "auth" && (
                    <View>
                      ...
                      <Text style={styles.authHint}>
                        To test, you need to provide an authentication token in
                  ...
                  {endpointStatus[endpoint.path]?.status === "manual" && (
                    <View>
                      <Text style={styles.manualText}>
                        This endpoint requires manual testing with a POST
                        request.
                      </Text>
            ...
            <View style={styles.notesList}>
              <View style={styles.noteItem}>
                ...
                <Text style={styles.noteText}>
                  Authenticated endpoints will show "Requires Auth" unless an
              ...
              <View style={styles.noteItem}>
                <View style={styles.bulletPoint} />
                <Text style={styles.noteText}>
                  POST endpoints require manual testing with appropriate request
                  bodies.
                </Text>
              </View>
              <View style={styles.noteItem}>
