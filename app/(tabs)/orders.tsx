        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <View style={styles.receiptHeader}>
              ...
              <Text style={styles.receiptSubtitle}>Order #{selectedOrder?.id}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 16, paddingTop: 50, backgroundColor: "#fff", alignItems: "center" },
  headerTitle: { fontSize: 22, fontWeight: "bold", color: "#000" },
  ordersList: { padding: 16 },
  orderItem: { padding: 16, borderBottomWidth: 1, borderBottomColor: "#eee", flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  orderNumber: { fontSize: 16, fontWeight: "600" },
  orderDate: { color: "#666" },
  emptyContainer: { flex: 1, justifyContent: "center", alignItems: "center" },
  emptyText: { fontSize: 16, color: "#666" },
  centeredView: { flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "rgba(0, 0, 0, 0.5)" },
  modalView: { width: "85%", backgroundColor: "#E6BF83", borderRadius: 15, padding: 20, elevation: 5 },
  receiptHeader: { alignItems: "center", marginBottom: 15, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: "rgba(0,0,0,0.1)" },
  ...
  totalContainer: { flexDirection: "row", justifyContent: "space-between", borderTopWidth: 1, borderTopColor: "#eee", paddingTop: 15, marginTop: 5 },
  totalLabel: { fontSize: 18, fontWeight: "bold" },
  totalAmount: { fontSize: 18, fontWeight: "bold" },
  orderAgainButton: { backgroundColor: "#E6BF83", padding: 15, borderRadius: 10, alignItems: "center", marginTop: 20 },
